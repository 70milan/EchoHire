#!/usr/bin/env python3
"""
Script to safely add session features to index.html
"""

# Read the working index.html from git
with open('frontend/index.html', 'r', encoding='utf-8') as f:
    content = f.read()

# 1. Add setup.css link after highlight.js script
content = content.replace(
    '  <script src="https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.9.0/highlight.min.js"></script>',
    '  <script src="https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.9.0/highlight.min.js"></script>\r\n  <link rel="stylesheet" href="setup.css">'
)

# 2. Add setup overlay before mini-icon
...
# 3. Add End Session button and session timer to controls
...
# 4. Add setup.js script before </body>
content = content.replace(
    '  </script>\r\n</body>',
...
print("Successfully added session features to index.html")
